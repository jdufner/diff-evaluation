...
public class DiffDecoratorUtils {
  ...
  public static abstract class Builder {
    ...
    private void addCharacterFromDeltaOrText(final int i, final Delta<Character> delta) {
      if (delta == null) {
        stringBuilder.append(getText().get(i));
      } else {
        stringBuilder.append(getFromChunkByIndex(getChunk(delta), i));
      }
    }
    ...
    private void addClosingTagIfDeltaAtLastElement(final int i, final Delta<Character> delta) {
    ...
    private void addOpeningTagIfDeltaAtFirstElement(final int i, final Delta<Character> delta) {
    ...
    private Character getFromChunkByIndex(final Chunk<Character> chunk, final int i) {
